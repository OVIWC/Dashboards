...
WQ_All <- inner_join(WQ_Result,WQ_Activity, by = "ActivityIdentifier") %>%
  select(CharacteristicName.x, ResultMeasureValue.x, ResultMeasureUnitCode.x, StartDate.y, StartTime.y, MonitoringLocationIdentifier.y, ProjectIdentifier.y) %>%
  rename(Characteristic = CharacteristicName.x, Result = ResultMeasureValue.x, Unit = ResultMeasureUnitCode.x, Date = StartDate.y, Time = StartTime.y, Site = MonitoringLocationIdentifier.y, Project = ProjectIdentifier.y) %>%
